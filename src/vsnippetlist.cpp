...
void VSnippetList::setupUI()
{
    ...
    m_shortcutBtn = new QPushButton(QIcon(":/resources/icons/snippet_shortcut.svg"), "");
    m_shortcutBtn->setToolTip(tr("Manage Shortcuts"));
    m_shortcutBtn->setProperty("FlatBtn", true);
    connect(m_shortcutBtn, &QPushButton::clicked,
            this, &VSnippetList::manageSnippetShortcut);
    ...
    btnLayout->addWidget(m_shortcutBtn);
...
void VSnippetList::manageSnippetShortcut()
{
